"""
Django settings for truequetools project.
...
SECRET_KEY = 'django-insecure-b-8^)t4br5#^g0ap)&+&n)0rgrox1flr&s1xw%-rftltl53qf2'
...
ROOT_URLCONF = 'truequetools.urls'
...
WSGI_APPLICATION = 'truequetools.wsgi.application'
